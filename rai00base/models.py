...
class DomaineAffaires(ProtoModelBase):
...
class Modele(ProtoModelBase):
    ...
    protoExt = {
        ...
        "detailsConfig": [{
            ...
            "__ptType": "detailDef",
            "conceptDetail": "rai00base.ModeleRaccordement",
...
class ElementDonnee(ProtoModelBase):
...
class ModeleRaccordement(ProtoModelBase):
...
class Raccordement(ProtoModelBase):
...
class Specifications(ProtoModelBase):
...
class IndexDesDonnees(ProtoModelBase):
...
class RegroupementDesModeles(ProtoModelBase):
...
class ReglesGestion(ProtoModelBase):
...
class PorteeRegleGestion(ProtoModelBase):
...
class TypeRegle(ProtoModelBase):
...
class CodageNormalise(ProtoModelBase):
